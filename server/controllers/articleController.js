...
function createArticle(req, res, next) {
    ...
    const { articleName,  createdAt, imageUrl, quantity, category, location, articleContent, creator, comments } = req.body;
    console.log(req.body)
    const { _id: userId } = req.user;

    articleModel.create({ articleName,  createdAt, imageUrl, quantity, category, location, articleContent, creator, userId, comments })
        .then((createdArticle) => {
